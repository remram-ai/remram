...
**Marketing Name (optional):** remram-intuition
**Layer:** Orchestration
**Primary Surface / Agent:** User Agent (pre-cognition stage)
**Relevant Hook or Stage (if applicable):** before_model_resolve-equivalent stage
**Dependencies (if any):** Provenance-aware retrieval and interaction pattern store
**Date:** 2026-02-28
**Status:** Shaping
