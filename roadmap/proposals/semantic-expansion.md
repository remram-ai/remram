...
Semantic Expansion Agent is a controlled semantic exploration subsystem that enriches retrieved memory with adjacent conceptual context before final evaluation. It operates as a short expansion loop, especially during the nightly Dream Routine, to surface subtle signals, weak associations, and overlooked relevance that fast daytime routing may miss.
