...
9. Present the package for leadership review.
...
- Approval advances the work to Stage 3.
- Revision requested loops back into proposal refinement.
- Rejection closes the idea unless leadership starts a new idea in intake.
