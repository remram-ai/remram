...
- Read [Stage 1 - Intake and Idea Formation](../../governance/lifecycle/stage-01-intake-and-idea-formation.md) for the intake workflow that produces these artifacts.
- Read [Stage 2 - Product Evaluation and Proposal](../../governance/lifecycle/stage-02-product-evaluation-and-proposal.md) for the next lifecycle step after an idea is approved.
