...
- Proposals are the decision-ready packages created during [Stage 2 - Product Evaluation and Proposal](https://github.com/remram-ai/remram-forge/blob/main/governance/lifecycle/stage-02-product-evaluation-and-proposal.md).
...
- Read [Ideas](../ideas/README.md) when work is still exploratory.
- Read [Stage 2 - Product Evaluation and Proposal](https://github.com/remram-ai/remram-forge/blob/main/governance/lifecycle/stage-02-product-evaluation-and-proposal.md) for the evaluation loop that produces these documents.
- Use [Features](../../features/README.md) once leadership approval creates an approved feature.
- Read [Stage 3 - Project Formation](https://github.com/remram-ai/remram-forge/blob/main/governance/lifecycle/stage-03-project-formation.md) for the next lifecycle handoff after proposal approval.
- Use [Platform Registry](../../platform/README.md) when approved feature work produces a defined platform deliverable.
