...
Flow:
1. User brain dumps idea by voice or text.
2. The system summarizes what it heard.
3. The system structures the capture into:
   - Core thesis
   - Supporting points
   - Assumptions
   - Open questions
4. The system runs a feasibility scan across technical, market, and effort dimensions.
5. The system asks for confirmation before vaulting.
6. The idea is stored, linked, and tagged.

Ongoing Interaction:
- "You have not revisited this idea in 6 months."
