...
The discovery outputs are consolidated into the [Idea document](../../schemas/idea-document.md).
...
The system assembles a user review package that may include the idea summary, workflows, feature list, conceptual mockups, and an optional [Audio brief](../../schemas/audio-brief.md).
...
- [Audio brief](../../schemas/audio-brief.md)
