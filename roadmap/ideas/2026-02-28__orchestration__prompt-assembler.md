...
**Marketing Name (optional):** remram-reprompt
**Layer:** Orchestration
**Primary Surface / Agent:** before_model_resolve, before_prompt_build
**Relevant Hook or Stage (if applicable):** Escalation prompt assembly
**Dependencies (if any):** Intent Calibration, Provenance Lookup, Retrieval Layer
**Date:** 2026-02-28
**Status:** Shaping
